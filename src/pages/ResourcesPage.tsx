  ...
  return (
    ...
    >
      <div className="container mx-auto px-4 py-12">
        ...
        <div className="mb-16">
          <h2 className="text-2xl md:text-3xl font-bold text-edwizer-blue mb-6 text-center">Downloadable Resources</h2>
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-6">
            {downloadableResources.map((resource, index) => (
              <Card key={index} className="border-edwizer-green/20 hover:border-edwizer-green/50 transition-all duration-300 shadow-md">
                <CardContent className="p-6">
                  <div className="rounded-full bg-edwizer-light w-12 h-12 flex items-center justify-center mb-4">
                    <FileText className="h-6 w-6 text-edwizer-blue" />
                  </div>
                  <h3 className="text-lg font-semibold text-edwizer-blue mb-2">{resource.title}</h3>
        ...
        <div className="mb-16">
          <h2 className="text-2xl md:text-3xl font-bold text-edwizer-blue mb-6 text-center">Video Resources</h2>
          <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
            <Card className="border-edwizer-green/20 hover:border-edwizer-green/50 transition-all duration-300 shadow-md overflow-hidden">
              <div className="h-48 relative">
                ...
                <div className="absolute inset-0 bg-black/30 flex items-center justify-center">
                  <div className="w-12 h-12 rounded-full bg-white/90 flex items-center justify-center">
                    <Video className="h-5 w-5 text-edwizer-blue" />
                  </div>
                </div>
              </div>
              <CardContent className="p-4">
                <h3 className="text-lg font-semibold text-edwizer-blue">How to Prepare for Engineering Entrance Exams</h3>
                <p className="text-sm text-gray-600 mt-1">Expert tips from top JEE rankers</p>
              </CardContent>
            </Card>
            ...
            <Card className="border-edwizer-green/20 hover:border-edwizer-green/50 transition-all duration-300 shadow-md overflow-hidden">
              <div className="h-48 relative">
                <img 
                  src="https://images.unsplash.com/photo-1536148935331-408321065b18?q=80&w=2069&auto=format&fit=crop" 
                  alt="Video thumbnail" 
                  className="w-full h-full object-cover"
                />
                <div className="absolute inset-0 bg-black/30 flex items-center justify-center">
              ...
              <CardContent className="p-4">
                <h3 className="text-lg font-semibold text-edwizer-blue">Mastering Time Management for Students</h3>
                <p className="text-sm text-gray-600 mt-1">Productivity techniques for academic success</p>
              </CardContent>
            </Card>
            ...
            <Card className="border-edwizer-green/20 hover:border-edwizer-green/50 transition-all duration-300 shadow-md overflow-hidden">
              ...
              <CardContent className="p-4">
                <h3 className="text-lg font-semibold text-edwizer-blue">Writing an Effective College Application Essay</h3>
                <p className="text-sm text-gray-600 mt-1">Crafting personal statements that stand out</p>
              </CardContent>
            </Card>
          </div>
        </div>
        ...
        <div className="bg-gradient-to-r from-edwizer-blue/10 to-edwizer-green/10 p-8 rounded-lg shadow-md mb-16">
          <h2 className="text-2xl font-bold text-edwizer-blue mb-6 text-center">Upcoming Webinars</h2>
          <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
            {upcomingWebinars.map((webinar, index) => (
              <Card key={index} className="border-none shadow-md">
                <CardContent className="p-6">
                  <div className="flex items-start">
                    <div className="rounded-full bg-edwizer-blue/10 w-16 h-16 flex items-center justify-center mr-4 flex-shrink-0">
                      <Calendar className="h-8 w-8 text-edwizer-blue" />
                    </div>
                    <div>
                      <h3 className="text-lg font-semibold text-edwizer-blue mb-1">{webinar.title}</h3>
                      <p className="text-sm text-gray-600 mb-1"><strong>Date:</strong> {webinar.date}</p>
                      <p className="text-sm text-gray-600 mb-1"><strong>Time:</strong> {webinar.time}</p>
                      <p className="text-sm text-gray-600 mb-3"><strong>Speaker:</strong> {webinar.speaker}</p>
