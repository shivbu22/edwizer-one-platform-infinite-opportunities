    ...
    >
      <div className="container mx-auto px-4 py-12">
        ...
        <div className="text-center mb-8">
          <h2 className="text-2xl md:text-3xl font-bold text-edwizer-blue mb-4">Ready to Get Started?</h2>
          <p className="text-gray-600 max-w-2xl mx-auto">
            Explore our services to find the support you need at your current stage of academic and career development. 
            Our team of experts is ready to guide you on your journey to educational and professional success.
          </p>
        </div>
